...
- **Muhasebeci şart.** Şirket açılışında ve sonrasında bir muhasebeciniz olması çok önemli. Güncel tarihte (Temmuz 2026) ortalama 4.000₺/aylık bandında rahatlıkla muhasebeci bulunabiliyor.
- **KEP adresi** için PTT'ye gidip işlemleri orada yapmanız yeterli, çok zorlayıcı bir süreç değil.
- Şirket açılışıyla birlikte **e-imza** almanız gerekiyor ve otomatik olarak **e-fatura mükellefi** oluyorsunuz.
- E-fatura için kullandığınız sisteme göre (Nettefatura, Paraşüt vb.) kontör almanız gerekiyor.
...
- **İlk sunucu:** Intel Xeon E5 V2 2697, 256 GB DDR3
- 1.5-2 ay içinde aynı firmadan toplam **5 fiziksel sunucuya** çıktık:
